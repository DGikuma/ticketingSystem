...
import adminDashboardKpisRoutes from "./routes/adminDashboardKpisRoutes";
...
app.use("/api/admin/dashboard", adminDashboardKpisRoutes);
...
console.table([
  ...
  { Path: "/api/admin/dashboard", Route: "adminDashboardKpisRoutes" },
]);
